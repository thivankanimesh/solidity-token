...
contract ThivaTokenCrowdsale is Crowdsale, MintedCrowdsale, CappedCrowdsale {
    ...
    constructor(uint256 rate, address payable wallet, IERC20 token, uint256 _cap) Crowdsale(rate, wallet, token) CappedCrowdsale(_cap) public {
